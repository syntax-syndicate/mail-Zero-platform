...
const MenuBar = ({ onAttachmentsChange }: { onAttachmentsChange?: (attachments: File[]) => void }) => {
  ...
  const removeAttachment = (index: number) => {
	...
	return (
		<>
          ...
          <Separator orientation="vertical" className="h-6 relative right-1 top-0.5" />
          <div className="mr-2 flex items-center gap-1">
            <button
            ...
            {attachments.length > 0 ? (
              <Popover>
                <PopoverTrigger asChild>
                  <button
                    className="hover:bg-muted relative rounded p-1.5 bg-background"
                ...
                <PopoverContent className="w-80 touch-auto" align="end">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between px-1">
                      <h4 className="font-medium leading-none">Attachments ({attachments.length})</h4>
                      <button
              ...
              <button
                onClick={handleAttachmentClick}
                className="hover:bg-muted rounded p-1.5 bg-background"
                title="Attach Files"
              >
                <Paperclip className="h-4 w-4" />
              </button>
