...
const AttachmentButtons = ({ attachments = [], onAttachmentAdd, onAttachmentRemove }: AttachmentButtonsProps) => {
  return (
      ...
      {attachments.length > 0 && (
        <Popover>
          <PopoverTrigger asChild>
            <button 
              className="rounded p-1.5 bg-background hover:bg-muted"
              style={{ 
                display: 'inline-flex',
                alignItems: 'center',
              ...
              <div className="h-[300px] touch-auto overflow-y-auto overscroll-contain px-1 py-1">
                <div className="grid grid-cols-2 gap-2">
                  {attachments.map((file, index) => (
                    ...
                    >
                      <UploadedFileIcon
                        removeAttachment={(index) => onAttachmentRemove && onAttachmentRemove(index)}
                        index={index}
                        file={file}
                      />
